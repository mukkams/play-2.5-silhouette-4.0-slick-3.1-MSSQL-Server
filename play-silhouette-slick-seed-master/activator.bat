...
set "JAVA_OPTS=-Dhttp.proxyHost=proxy.emea.westlb.net -Dhttp.proxyPort=8080 -Dhttps.proxyHost=proxy.emea.westlb.net -Dhttps.proxyPort=4430 -Dhttp.nonProxyHosts=localhost"
